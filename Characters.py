...
charcters = {"John Ruth": {"Description": "A grisled bounty hunter \
with a scar on his right eye",
                           "Health": 120,
                           "Attack": 45,
                           "Defense": 30},
             "Austin Maverick":
                          {"Descrpition": "A lawman who deals out \
justice the way he sees fit",
                           "Health": 100,
                           "Attack": 50,
                           "Defense": 25},
             "Gunner Ace":
                          {"Description": "An outlaw, \
framed by a coript sheif for murder",
                           "Health": 110,
                           "Attack": 40,
                           "Defense": 35},
             "Jake \"The Snake\" Calloway":
                          {"Descrpition": "A dirty outlaw wanted \
for robbery across the state",
                           "Health": 95,
                           "Attack": 55,
                           "Defense": 25}}
