...
decriptions = {"Tumbleweed":
                           {"Description": "A dry, dying town in the middle of the desert"},
               "Rattlesnake farm":
                           {"Desription": "An old cattle farm turned into a gang hideout by Jake \"The Snake\""},
               "Claymore": {"Desription": "A small, mostly abandoned settlment with houses made of clay"},
               "New Highlands":
                           {"Descrpition": "A new, classy town",},
               "Great Bear Falls":
                           {"Descrpition": "An enormous water falls that leads into the White water river"}}
